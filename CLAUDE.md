...
## Status
**M00–M24 are built** (236 sections; M00–M10 and M16 also verified in a browser), each carrying 8+ concepts
with full explanations, two worked examples, a reference entry and a graded exercise. The tree is
green. **M25 — context-free languages and parsing is next**, and nothing of it
