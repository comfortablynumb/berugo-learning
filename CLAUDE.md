...
## Status
**M00–M21 are built** (203 sections; M00–M10 and M16 also verified in a browser), each carrying 8+ concepts
with full explanations, two worked examples, a reference entry and a graded exercise. The tree is
green. **M22 — compression, information theory and error correction is next**, and nothing of it
