...
## Status
**M00–M17 are built** (166 sections; M00–M10 and M16 also verified in a browser), each carrying 8+ concepts
with full explanations, two worked examples, a reference entry and a graded exercise. The tree is
green. **Next is M18 — numerical methods, transforms and optimisation**; read `doc/BUILD-STATE.md`
