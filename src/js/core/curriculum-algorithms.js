...
(function (root, factory) {
  ...
  if (scope) scope.CurriculumAlgorithms = api;
}(this, function (scope) {
  'use strict';

  /* M17 onward lives in its own file: the track outgrew a thousand lines at
     M23, and the seam is at a milestone boundary so nothing else moves. */
  const later = scope && scope.CurriculumAlgorithmsLater
    ? scope.CurriculumAlgorithmsLater
    : require('./curriculum-algorithms-later.js');
